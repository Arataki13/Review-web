      ...
      {activeTab === 'explore' ? (
        <div>
          <div className="pb-6 border-b border-zinc-800/60 mb-6">
            <h1 className="text-3xl font-extrabold tracking-tight text-zinc-100">Discover Games</h1>
            <p className="text-zinc-400 mt-1">Browse and search games to decide what to play.</p>
          </div>
          <GameGrid />
        </div>
      ) : (
        <CategoryPage category="game" title="Games Tracker" />
      )}
    </div>
  );
}
